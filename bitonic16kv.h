...
//    dumpavx512(a1, b1, "after 1st compare");
    ...
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index0), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index0), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index0), bi1);
    static int64_t __attribute__ ((aligned(64)))  index1[8]={9,1,11,3,13,5,15,7};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index1), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index1), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index1), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index2[8]={0,9,2,11,4,13,6,15};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index2), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index2), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index2), bi1);
    static int64_t __attribute__ ((aligned(64)))  index3[8]={1,8,3,10,5,12,7,14};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index3), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index3), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index3), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index4[8]={0,8,1,9,4,12,5,13};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index4), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index4), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index4), bi1);
    static int64_t __attribute__ ((aligned(64)))  index5[8]={11,3,10,2,15,7,14,6};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index5), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index5), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index5), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index6[8]={0,1,11,10,4,5,15,14};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index6), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index6), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index6), bi1);
    static int64_t __attribute__ ((aligned(64)))  index7[8]={2,3,9,8,6,7,13,12};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index7), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index7), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index7), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index8[8]={0,8,2,10,4,12,6,14};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index8), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index8), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index8), bi1);
    static int64_t __attribute__ ((aligned(64)))  index9[8]={1,9,3,11,5,13,7,15};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index9), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index9), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index9), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index10[8]={0,8,1,9,2,10,3,11};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index10), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index10), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index10), bi1);
    static int64_t __attribute__ ((aligned(64)))  index11[8]={15,7,14,6,13,5,12,4};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index11), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index11), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index11), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index12[8]={0,1,2,3,15,14,13,12};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index12), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index12), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index12), bi1);
    static int64_t __attribute__ ((aligned(64)))  index13[8]={4,5,6,7,11,10,9,8};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index13), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index13), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index13), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index14[8]={0,1,8,9,4,5,12,13};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index14), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index14), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index14), bi1);
    static int64_t __attribute__ ((aligned(64)))  index15[8]={2,3,10,11,6,7,14,15};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index15), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index15), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index15), bi1);

    compare_and_swap16(au, al, ai, bu, bl, bi, au1, al1, ai1,  bu1, bl1, bi1);
    static int64_t __attribute__ ((aligned(64)))  index16[8]={0,8,2,10,4,12,6,14};
    au= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index16), bu1);
    al= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index16), bl1);
    ai= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index16), bi1);
    static int64_t __attribute__ ((aligned(64)))  index17[8]={1,9,3,11,5,13,7,15};
    bu= _mm512_permutex2var_epi64 (au1, _mm512_load_epi64(index17), bu1);
    bl= _mm512_permutex2var_epi64 (al1, _mm512_load_epi64(index17), bl1);
    bi= _mm512_permutex2var_epi64 (ai1, _mm512_load_epi64(index17), bi1);
